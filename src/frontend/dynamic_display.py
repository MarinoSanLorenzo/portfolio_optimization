...
app.layout = html.Div(
    [
        ...
        dcc.Dropdown(
            id="memory-countries",
            options=[{"value": x, "label": x} for x in countries],
            multi=True,
...
@app.callback(Output("memory-output", "data"), Input("memory-countries", "value"))
...
@app.callback(Output("memory-table", "data"), Input("memory-output", "data"))
